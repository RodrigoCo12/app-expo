...
//   // Verificar si el USUARIO ya hizo un reporte para esta hora (MODIFICADO)
...
//         // Verificar si el reporte existente es para la hora ACTUAL
//         const reporteEsParaHoraActual = data.reporte && data.reporte.hora_de_reporte === horaActual;

//         setReporteEnviado(reporteEsParaHoraActual);
//         console.log(data);
...
//         console.log("Reporte enviado:", reporteEsParaHoraActual);
//         console.log("===========================");
//       } else {
...
//   // Crear reporte (MODIFICADO - ahora usa array de guardias activos)
...
//       formData.append("guardias", nombresGuardias.join(", ")); // Enviar como string separado por comas
...
//       // 4. Log para confirmación
//       console.log("=== REPORTE ENVIADO EXITOSAMENTE ===");
//       console.log("Reporte enviado (después): true");
//       console.log("Ubicación:", locacion);
//       console.log("Guardias incluidos:", nombresGuardias);
//       console.log("Hora creación:", responseData.reporte?.createdAt);
//       console.log("===================================");
//     } catch (error) {
