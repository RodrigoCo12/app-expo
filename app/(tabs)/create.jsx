...
//       console.log("Raw response:", text); // Verifica si es HTML o JSON
...
export default function Create() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Adjuntar la imagen - IMPORTANTE: Usar el nombre exacto que espera el servidor
      ...
      Alert.alert("Éxito", "¡Tu recomendación de libro ha sido publicada!");
      resetForm();
      router.push("/");
    } catch (error) {
    ...
    >
      <ScrollView contentContainerStyle={styles.container} style={styles.scrollViewStyle}>
        <View style={styles.card}>
          {/* HEADER */}
          <View style={styles.header}>
            <Text style={styles.title}>Añadir Recomendación de Libro</Text>
          ...
          <View style={styles.form}>
            ...
            {/* IMAGE */}
            <View style={styles.formGroup}>
              <Text style={styles.label}>Imagen del Libro</Text>
              <TouchableOpacity style={styles.imagePicker} onPress={pickImage}>
                {image ? (
                  <Image source={{ uri: image }} style={styles.previewImage} />
                ) : (
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                style={styles.textArea}
                placeholder="Escribe tu reseña o comentarios sobre este libro..."
                placeholderTextColor={COLORS.placeholderText}
                value={caption}
                onChangeText={setCaption}
                multiline
