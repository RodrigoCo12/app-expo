...
//                     })
//                     .join("")
//                 : '<tr><td colspan="3" style="text-align: center; padding: 15px;">No hay guardias activos en este período</td></tr>'
//             }
//           </tbody>
//         </table>
...
//           <h3 style="margin: 0 0 15px 0; color: #2c5aa0;">Resumen General</h3>
...
//             // Calcular estadísticas para esta ubicación
//             const totalReportes = horasFiltradas.filter((hora) => {
//               return this.findReportForHour(reportes, hora);
//             }).length;
...
//                 ? Math.round((totalReportes / horasFiltradas.length) * 100)
//                 : 0;

//             return `
//               <div class="location-section">
//                 <div class="location-title">
//                   ${location} - ${guards.length} guardia${guards.length !== 1 ? "s" : ""} en el período - ${porcentajeReportes}% de reportes completados
//                 </div>

//                 <h4 style="color: #2c5aa0; margin: 15px 0 10px 0; font-size: 12px;">Guardias en el Período</h4>
...
//                             })
//                             .join("")
//                         : '<tr><td colspan="3" style="text-align: center; padding: 10px;">No hay guardias activos en este período</td></tr>'
//                     }
//                   </tbody>
//                 </table>

//                 <h4 style="color: #2c5aa0; margin: 20px 0 10px 0; font-size: 12px;">Reportes por Hora</h4>
//                 <table class="table">
//                   <thead>
//                     <tr>
//                       <th>Fecha</th>
...
//                                   ? `<div class="guards-list">${activeGuards
//                                       .map((guard) => {
//                                         const estadoGuardia = this.getGuardStatusAtTime(
//                                           guard,
//                                           hora
//                                         );
//                                         let flecha = "";
...
//         <div class="footer">
//           <p>Sistema de Reportes de Guardias - Reporte General</p>
//           <p>© ${now.getFullYear()} - Todos los derechos reservados</p>
//         </div>
//       </body>
//       </html>
